...
{   
    ...
    /*
    gsNurbs<scalar> rotation360 = Structure::createNurbs({0,0,1,1},1,{1,1},{0,2*pi}); // 360° Rotation
    Info<<"Generated rotation360"<<Foam::endl;
    CrossSection rotatingEllipse(0.1,{0,0.05},{0,0},rotation360); //Ellipse
    */
    Info<<"Start"<<Foam::endl;
    CrossSection ellipse(0.2,{0,0.05},{0,0}); //Ellipse    
    Info<<"Generated cross section"<<Foam::endl;
    CrossSectionStructure structure(mesh,{ellipse});
