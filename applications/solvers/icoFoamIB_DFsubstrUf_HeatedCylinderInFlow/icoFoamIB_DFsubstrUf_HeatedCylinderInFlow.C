...
int main(int argc, char *argv[])
{
    ...
    TemperatureInteraction Tf_Interaction(mesh,T,Tf);
    structure.transferMarkers(Tf_Interaction);
    ...
    while (runTime.loop())
    {
        ...
        Tf_Interaction.interpolateTemperatureToMarkers();
        Tf_Interaction.computeCouplingHeatingOnMarkers();
        Tf_Interaction.computeRodHeating();
        Tf_Interaction.interpolateHeatingField();
        Info<<"sum Heating:"<<Tf_Interaction.sumHeating()<<Foam::endl;
