...
int main(int argc, char *argv[])
{
    ...
    List<scalar> crossSecArea = {0.03141};
    LineStructure structure(mesh,crossSecArea);
    VelocityPressureForceInteraction Uf_Interaction(mesh,U,Uf_dummy);
            ...
            */
            ...
            while (piso.correct())
            {
                ...
                while (piso.correctNonOrthogonal())
                {
                    ...
                    fvScalarMatrix pEqn
                    (
                        fvm::laplacian(rAU, p) == fvc::div(phiHbyA) - rAU*fvc::div(Uf)
                    );
