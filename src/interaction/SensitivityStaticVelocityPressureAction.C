#include "SensitivityVelocityPressureAction.H"

Foam::SensitivityVelocityPressureAction::SensitivityVelocityPressureAction
(
    const fvMesh& mesh,
...
SensitivityVelocityPressureForceInteraction(mesh,structure,structureDict,modusFieldToMarker,modusMarkerToField),
