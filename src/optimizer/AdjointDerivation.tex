...
\delta_\Gamma J + \int_{\Omega \cup X}
\begin{pmatrix}
	\frac{1}{\rho}\lambda_{\vec{u}} \\ \lambda_{U_M}\\ \frac{1}{\rho} \lambda_{T_{\text{fluid}}} \\ \lambda_{T_{\text{fluid}_M}}
\end{pmatrix}
\cdot
\begin{pmatrix}
	\sum_X -F_u \delta \Gamma \delta(\vec{x}-\vec{X}) \\
...
\begin{pmatrix}
	  q_0 ^2 + q_1 ^2 - q_2 ^2 - q_3 ^2 & -2q_0 q_3 + 2 q_1 q_2  &  2q_0 q_2 + 2q_1 q_3 \\
	  2q_0 q_3 + 2 q_1 q_2 & q_0 ^2 - q_1 ^2 + q_2 ^2 - q_3 ^2 & -2q_0 q_1 + 2 q_2 q_3 \\
	 -2q_0 q_2 + 2 q_1 q_3 &   2q_0 q_1 + 2 q_2 q_3  & q_0 ^2 - q_1 ^2 - q_2 ^2 + q_3 ^2 \\
\end{pmatrix}$\\
...
$\frac{\partial \vec{d}_3}{\partial \vec{q}} = ´
	\begin{pmatrix}
		...
		2q_0 &-2q_1&  -2q_2  & 2q_3 \\
	\end{pmatrix}$\\
$\frac{\partial^2 \vec{d}_1}{\partial \vec{q}^2} = ´
	\begin{pmatrix}
		2 & 2 &-2 &-2 \\
		0 & 0 & 0 & 0 \\
		0 & 0 & 0 & 0 \\
	\end{pmatrix}$\\
$\frac{\partial^2 \vec{d}_2}{\partial \vec{q}^2} = ´
	\begin{pmatrix}
		0 & 0 & 0 & 0 \\
		2 &-2 & 2 &-2 \\
		0 & 0 & 0 & 0 \\
	\end{pmatrix}$\\
$\frac{\partial^2 \vec{d}_3}{\partial \vec{q}^2} = ´
	\begin{pmatrix}
		0 & 0 & 0 & 0 \\
		0 & 0 & 0 & 0 \\
		2 &-2 &-2 & 2 \\
